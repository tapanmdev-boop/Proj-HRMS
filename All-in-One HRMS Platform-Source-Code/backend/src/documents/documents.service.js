...
var DocumentsService = function () {
    ...
    var DocumentsService = _classThis = /** @class */ (function () {
        function DocumentsService_1(s3Service) {
            this.s3Service = s3Service;
        }
        DocumentsService_1.prototype.uploadDocument = function (buffer, fileName, mimeType, fileSize, employeeId, type, tenantId, key) {
            return __awaiter(this, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.s3Service.uploadFile({
                                buffer: buffer,
