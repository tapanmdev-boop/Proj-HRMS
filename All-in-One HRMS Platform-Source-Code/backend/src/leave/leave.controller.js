...
var LeaveController = function () {
    var _classDecorators = [(0, common_1.Controller)('leave')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _getAll_decorators;
    var LeaveController = _classThis = /** @class */ (function () {
        function LeaveController_1() {
            __runInitializers(this, _instanceExtraInitializers);
        }
        LeaveController_1.prototype.getAll = function () {
            // Return all leave requests here
            return [];
        };
        return LeaveController_1;
    }());
