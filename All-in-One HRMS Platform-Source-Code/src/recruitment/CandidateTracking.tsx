		...
		<>
			...
			<div className="bg-white rounded-xl border border-ivory-300 shadow-premium-sm p-6 mb-6">
				<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
					...
					<div className="flex items-end">
						<button
							className="h-9 px-4 bg-white border border-ivory-400 rounded-btn shadow-premium-sm text-[13.5px] font-medium text-ink-900 hover:border-gray-400 hover:bg-ivory-50"
							onClick={() => {
								setStatusFilter('all');
			...
			{showAddModal && (
				<div className="fixed inset-0 flex items-center justify-center bg-ink-950/50 backdrop-blur-[2px] z-50">
					<div className="bg-white rounded-xl border border-ivory-300 shadow-premium-lg p-6 w-full max-w-md">
						<h3 className="text-[15px] font-semibold tracking-[-0.01em] text-ink-900 mb-4">Add Candidate</h3>
			...
			{viewingCandidateId && (() => {
				...
				return (
					<div className="fixed inset-0 flex items-center justify-center bg-ink-950/50 backdrop-blur-[2px] z-50">
						<div className="bg-white rounded-xl border border-ivory-300 shadow-premium-lg p-6 w-full max-w-md">
							<h3 className="text-[15px] font-semibold tracking-[-0.01em] text-ink-900 mb-4">{candidate.name}</h3>
			...
			{updatingCandidateId && (
				<div className="fixed inset-0 flex items-center justify-center bg-ink-950/50 backdrop-blur-[2px] z-50">
					<div className="bg-white rounded-xl border border-ivory-300 shadow-premium-lg p-6 w-full max-w-md">
						<h3 className="text-[15px] font-semibold tracking-[-0.01em] text-ink-900 mb-4">Update Status</h3>
