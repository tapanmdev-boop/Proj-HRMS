    ...
    <div className="space-y-6">
      <div className="bg-white rounded-xl border border-ivory-300 shadow-premium-sm p-6">
        <div className="flex flex-col md:flex-row justify-between mb-6">
          <h2 className="font-display text-[26px] font-medium leading-tight tracking-[-0.02em] text-ink-900 mb-4 md:mb-0">Attendance Management</h2>
        ...
        {activeTab === 'overview' && (
          <div className="space-y-6">
            ...
            <div className="p-6 bg-indigo-50 rounded-lg border border-indigo-100">
              <h3 className="text-[15px] font-semibold tracking-[-0.01em] text-ink-900 mb-4">Today's Attendance</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="bg-white p-4 rounded-xl border border-ivory-300 shadow-premium-sm">
            ...
            <div>
              <h3 className="text-[15px] font-semibold tracking-[-0.01em] text-ink-900 mb-4">Recent Attendance</h3>
        ...
        {activeTab === 'my-attendance' && (
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-[15px] font-semibold tracking-[-0.01em] text-ink-900 mb-4">Attendance History</h3>
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
