...
function MeetingDetails({
	...
	return (
		<div className="bg-white p-6 rounded-xl border border-ivory-300 shadow-premium-sm">
			<h2 className="font-display text-[22px] font-medium tracking-[-0.015em] text-ink-900 mb-4">Meeting Details</h2>
			...
			<div className="mb-6">
				<h3 className="text-[15px] font-semibold tracking-[-0.01em] text-ink-900 mb-2">Notes</h3>
				<Textarea
					label="Meeting Notes"
					id="meetingNotes"
					rows={4}
			...
			<div className="mb-6">
				<h3 className="text-[15px] font-semibold tracking-[-0.01em] text-ink-900 mb-2">Action Items</h3>
			...
			{selectedMeeting && (
				<div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
					...
					<div className="bg-white rounded-xl border border-ivory-300 shadow-premium-sm p-6">
						<h3 className="text-[15px] font-semibold tracking-[-0.01em] text-ink-900 mb-4">Meeting Information</h3>
					...
					<div className="md:col-span-2 bg-white rounded-xl border border-ivory-300 shadow-premium-sm p-6">
						<h3 className="text-[15px] font-semibold tracking-[-0.01em] text-ink-900 mb-4">Meeting Agenda & Notes</h3>
		...
		{showScheduleModal && (
			<div className="fixed inset-0 flex items-center justify-center bg-ink-950/50 backdrop-blur-[2px] z-50">
				<div className="bg-white rounded-xl border border-ivory-300 shadow-premium-lg p-6 w-full max-w-md">
					<h3 className="text-[15px] font-semibold tracking-[-0.01em] text-ink-900 mb-4">Schedule New Meeting</h3>
