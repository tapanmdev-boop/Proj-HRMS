...
-- CreateEnum
CREATE TYPE "AttendanceStatus" AS ENUM ('PRESENT', 'ABSENT', 'LATE', 'HALF_DAY', 'ON_LEAVE', 'WORK_FROM_HOME');
...
-- CreateEnum
CREATE TYPE "DocumentType" AS ENUM ('RESUME', 'CONTRACT', 'ID_PROOF', 'ADDRESS_PROOF', 'CERTIFICATE', 'PAYSLIP', 'OTHER');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('INFO', 'WARNING', 'SUCCESS', 'ERROR', 'LEAVE_REQUEST', 'LEAVE_APPROVAL', 'DOCUMENT_UPLOAD', 'PAYSLIP');
